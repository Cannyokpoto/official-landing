...
function Header() {
  ...
  return (
    <header className='flex items-center border large:justify-around w-100vw h-80px bg-vogueWhite small:justify-between small:px-3 large:px-0'>
      ...
      <nav className={`items-center justify-center list-none large:flex large:h-auto large:w-50 text-15px small:absolute small:top-0 small:left-0 bg-vogueWhite small:z-40 small:h-100vh small:border large:border-0 large:static small:pl-2 large:pl-0 small:w-70vw small:${nav && 'flex'} hidden`}>
